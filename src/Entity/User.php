...
use App\Controller\UserSendEmailAction;
...
#[ApiResource(
    operations: [
        ...
        new Get(
            openapiContext: ['summary' => 'id'],
            security: "object == user || is_granted('ROLE_USER')",
        ),
        new Post(
            controller: UserCreateAction::class,
        ),
        new Post(
            uriTemplate: 'users/send_email',
            controller: UserSendEmailAction::class,
            openapiContext: ['summary' => 'Send email. Just for test'],
            denormalizationContext: ['groups' => ['user:empty']],
            name: 'sendEmail'
        ),
        new Put(
